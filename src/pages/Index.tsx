...
const Index = () => {
  ...
  const timelineData = [
    ...
    },
    {
      ...
      description: "Driven by the passion for Cloud and DevOps, I enjoy designing scalable cloud solutions, automating workflows, solving real-world problems and actively seeking out opportunities to collaborate on freelance projects that challenge me to learn and grow.",
      highlights: [
